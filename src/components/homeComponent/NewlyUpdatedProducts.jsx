...
const NewlyUpdatedProducts = () => {
    ...
    return (
        <section id="newly-updated-products" className="py-4">
            <div className="container">
                <h2 className="text-primary border-bottom pb-2 mb-4">Sản phẩm mới cập nhật</h2>
                <div className="position-relative">
                    ...
                    <button className="btn btn-primary position-absolute top-50 start-0 translate-middle-y"
                            id="scrollLeft" style={{zIndex: 2}}>
                        <i className="fas fa-chevron-left"></i>
                    </button>
                    <button className="btn btn-primary position-absolute top-50 end-0 translate-middle-y"
                            id="scrollRight" style={{zIndex: 2}}>
...
export default NewlyUpdatedProducts;
